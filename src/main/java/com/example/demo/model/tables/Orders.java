...
public class Orders extends TableImpl<OrdersRecord> {
    ...
    private static final long serialVersionUID = -1534643646;
     ...
     */
    public final TableField<OrdersRecord, Timestamp> ORDERDATE = createField("orderDate", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "", new DateAsTimestampBinding());

    /**
     * The column <code>classicmodels.orders.requiredDate</code>.
     */
    public final TableField<OrdersRecord, Timestamp> REQUIREDDATE = createField("requiredDate", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "", new DateAsTimestampBinding());

    /**
     * The column <code>classicmodels.orders.shippedDate</code>.
     */
    public final TableField<OrdersRecord, Timestamp> SHIPPEDDATE = createField("shippedDate", org.jooq.impl.SQLDataType.TIMESTAMP, this, "", new DateAsTimestampBinding());
