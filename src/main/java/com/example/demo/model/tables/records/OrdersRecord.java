...
public class OrdersRecord extends UpdatableRecordImpl<OrdersRecord> implements Record7<Integer, Timestamp, Timestamp, Timestamp, String, String, Integer> {

    private static final long serialVersionUID = -2079563038;
     ...
     */
    @Override
    public Row7<Integer, Timestamp, Timestamp, Timestamp, String, String, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row7<Integer, Timestamp, Timestamp, Timestamp, String, String, Integer> valuesRow() {
     ...
     */
    @Override
    public OrdersRecord values(Integer value1, Timestamp value2, Timestamp value3, Timestamp value4, String value5, String value6, Integer value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OrdersRecord(Integer ordernumber, Timestamp orderdate, Timestamp requireddate, Timestamp shippeddate, String status, String comments, Integer customernumber) {
        super(Orders.ORDERS);
